                ...
                <v-col sm="10" class="mx-auto">
                    <v-card class="pa-0">
                        ...
                        <v-form @submit.prevent="submitForm" ref="form" class="pa-5" enctype="multipart/form-data">
                            ...
                            <v-file-input @change="selectImage" ref="image" accept="image/*" :rules="rules"
                                variant="underlined" color="indigo" chips show-size counter label="Elige una imagen" />
    ...
    methods: {
        ...
        async submitForm() {
            ...
            if (this.$refs.form.validate()) {
                const res = await PostService.setPost(formData);
